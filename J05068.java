...
public class J05068 {
    ...
    public J05068(String maDonHang, long soLuong) {
    ...
    public static void main(String[] args) {
        ...
        J05068[] a = new J05068[n];
        for (int i = 0; i < n; i++) {
            String s = sc.nextLine();
            String[] words = s.split("\\s+");
            a[i] = new J05068(words[0], Long.parseLong(words[1]));
            a[i].setDonGia();
            a[i].setHangSanXuat();
            a[i].setThue();
            a[i].setThanhTien();
        ...
        Arrays.sort(a, new Comparator<J05068>() {
            @Override
            public int compare(J05068 t, J05068 t1) {
                return Long.compare(t1.thanhTien, t.thanhTien);
            }
        });
        for (int i = 0; i < n; i++) {
