...
public class J05061 {
    ...
    public J05061(int maTT, String hoTen) {
    ...
    public static void main(String[] args) {
        ...
        Arrays.sort(a, new Comparator<J05061>() {
            @Override
            public int compare(J05061 t, J05061 t1) {
                return t1.diemTB - t.diemTB;
            }
        });
