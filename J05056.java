...
public class J05056 {
    ...
    public J05056(int ma, String hoTen, String ngaySinh) {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
         ...
         Arrays.sort(a, new Comparator<J05056>() {
            @Override
            public int compare(J05056 t, J05056 t1) {       
