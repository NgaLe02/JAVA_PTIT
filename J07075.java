...
public class J07075 {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        System.out.println("LICH GIANG DAY GIANG VIEN " + find + ":");

        for (LichGD x : b) {
            if (x.hoTen.equals(find)) {
                System.out.print(x.maNhom + " ");
                for(MonHoc y : a) {
                    if(y.maMon.equals(x.maMon)) {
                        System.out.print(y.tenMon + " ");
                        break;
                    }
                }
                System.out.println(x.thu + " " + x.kip + " " + x.phongHoc);
            }
        }
    }
}